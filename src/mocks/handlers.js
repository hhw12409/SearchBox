...
export const handlers = [
  rest.get('/attractions', async (req, res, ctx) => {
  ...
  rest.put('/attractions/:attractionId/like', async (req, res, ctx) => {
  ...
  rest.delete('/attractions/:attractionId/like', async (req, res, ctx) => {
    const { attractionId } = req.params
    const likes = JSON.parse(sessionStorage.getItem(LIKES_STORAGE_KEY) || '{}')
